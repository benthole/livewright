...
if ($_POST) {
    ...
    if ($action === 'add') {
        ...
        if (empty($coach_name)) {
            ...
            $default_rates = [
                [60, 1, 750.00], [60, 3, 700.00], [60, 5, 650.00], [60, 10, 600.00], [60, 20, 550.00],
                [45, 1, 560.00], [45, 3, 525.00], [45, 5, 487.50], [45, 10, 450.00], [45, 20, 412.50],
                [30, 1, 375.00], [30, 3, 350.00], [30, 5, 325.00], [30, 10, 300.00], [30, 20, 275.00],
            ];
...
?>
    ...
    <div class="admin-content">
        ...
        <?php if (empty($coaches)): ?>
            <div style="text-align: center; padding: 40px; color: #666; background: white; border-radius: 8px; border: 1px solid #ddd;">
